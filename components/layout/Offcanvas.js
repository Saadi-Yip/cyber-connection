                                ...
                                <ul>
                                    <li className="d-flex align-items-center">
                                        ...
                                        <div className="offcanvas__contact-text">
                                            <Link target="_blank" href="#">215 Debbie Ann Ct, Auburndale, FL 33823</Link>
                                        </div>
                                    </li>
                                    <li className="d-flex align-items-center">
                                        ...
                                        <div className="offcanvas__contact-text">
                                            <Link href="/mailto:info@azent.com"><span className="mailto:info@example.com">sales@cyberconnection.site</span></Link>
                                        </div>
                                    </li>
                                    <li className="d-flex align-items-center">
                                        <div className="offcanvas__contact-icon mr-15">
